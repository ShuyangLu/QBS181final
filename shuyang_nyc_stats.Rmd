...
library(ggpubr)
color.custom <- c("#264653")
fill.custom <- c("#2a9d8f")
p1 <- ggboxplot(add_season_test$Day.Average.Temp, xlab="Daily Average Temperature", ylab="Fahrenheit Degree",title = "Boxplot of Daily Average Temperature")

p1

color.custom <- c("#264653")
fill.custom <- c("#2a9d8f")
p2 <- ggboxplot(add_season_test$Day.Average.Temp, xlab="Daily Average Temperature", ylab="Fahrenheit Degree",title = "Boxplot of Daily Average Temperature")+
