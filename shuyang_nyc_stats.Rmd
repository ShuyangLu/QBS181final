...
```
## density of temperature and cases
```{r}
par(mfrow=c(1, 2))  # divide graph area in 2 columns
plot(density(add_season_test$Day.Average.Temp), main="Density Plot: Temperature", ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(cars$speed), 2))) 
polygon(density(add_season_test$Day.Average.Temp), col="green")
plot(density(add_season_test$Case_Count_7Day_Avg), main="Density Plot:COVID cases", ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(cars$speed), 2)))
polygon(density(add_season_test$Case_Count_7Day_Avg), col="red")
```
